package com.examplebatch.batchdemo.config;
...
public class AppConfig {
    ...
    public AppConfig(JobExplorer jobExplorer,
    ...
    public ThreadPoolTaskExecutor jobOperatorExecutor() {
        ...
        threadPoolTaskExecutor.setCorePoolSize(JOB_OPERATOR_CORE_POOL_SIZE);
        threadPoolTaskExecutor.setMaxPoolSize( JOB_OPERATOR_MAX_POOL_SIZE);
